...
#pipe = StableDiffusionDepth2ImgPipeline.from_pretrained("/home/ubuntu/diffusersfood/data_t/watermelon_h")
pipe = StableDiffusionDepth2ImgPipeline.from_pretrained("/home/ubuntu/watermelon_x1")
pipe = pipe.to("cuda")


image = Image.open("/home/ubuntu/expp/aligned0.png").convert("RGB").resize((128, 128))
depth_map = Image.open("/home/ubuntu//expp/depth2.png").convert("RGB").resize((128, 128))
...
result, _ = pipe("a photo of a watermelon cross section", image=image, depth_map=depth_map_tensor_resized, strength=0.4, num_inference_steps=100)
#compare(result[0][0], image, cmap="gray", start_mode="horizontal", start_slider_pos=0.73)

result[0][0].save("/home/ubuntu/x1_res/dw_result.png")

image.save("/home/ubuntu/x1_res/raw_result.png")
...
depth_map_pil.save("/home/ubuntu/x1_res/depth_result.png")
